...
public class MapGenerator : MonoBehaviour
{
    ...
    public int mapChunkSize
    {
        get
        {
            return terrainData.useFlatShading ? MeshGenerator.supportedFlatshadedChunkSizes[flatshadedChunkSizeIndex] - 1 : MeshGenerator.supportedChunkSizes[chunkSizeIndex] - 1;
        }
    }
